...
def test_alignment_summary_v1124_01(alignment_summary_v1124_01, attrs, exp):
    assert getattr_nested(alignment_summary_v1124_01.json, attrs) == exp, ", ".join(
...
def test_insert_size_v1124_01(insert_size_v1124_01, attrs, exp):
    assert getattr_nested(insert_size_v1124_01.json, attrs) == exp, ", ".join(
        [repr(x) for x in attrs]
    )
...
def test_library_complexity_v1124_01(library_complexity_v1124_01, attrs, exp):
    assert getattr_nested(library_complexity_v1124_01.json, attrs) == exp, ", ".join(
        [repr(x) for x in attrs]
    )
...
def test_mark_duplicates_v1124_01(mark_duplicates_v1124_01, attrs, exp):
    assert getattr_nested(mark_duplicates_v1124_01.json, attrs) == exp, ", ".join(
        [repr(x) for x in attrs]
    )
...
def test_rna_seq_v1124_01(rna_seq_v1124_01, attrs, exp):
    assert getattr_nested(rna_seq_v1124_01.json, attrs) == exp, ", ".join(
        [repr(x) for x in attrs]
    )
...
def test_wgs_v1124_01(wgs_v1124_01, attrs, exp):
    assert getattr_nested(wgs_v1124_01.json, attrs) == exp, ", ".join(
        [repr(x) for x in attrs]
    )
